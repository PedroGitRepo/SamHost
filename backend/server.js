...
const wowzaControlRoutes = require('./routes/wowza-control');
...
app.use(cors({
  origin: isProduction ? [
    'http://novo.samcast.com.br',
    'https://novo.samcast.com.br',
    'http://novo.samcast.com.br:3000',
    'http://novo.samcast.com.br:3001',
    'https://novo.samcast.com.br:3001'
  ] : [
    'http://localhost:3000',
    'http://127.0.0.1:3000',
    'http://localhost:3001',
...
app.use('/api/wowza-control', wowzaControlRoutes);
