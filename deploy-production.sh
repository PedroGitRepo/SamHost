...
if [ ! -f "/etc/nginx/sites-enabled/novo.samcast.com.br" ]; then
    echo "⚙️ Configurando Nginx..."
    sudo cp nginx.conf /etc/nginx/sites-available/novo.samcast.com.br
    sudo ln -s /etc/nginx/sites-available/novo.samcast.com.br /etc/nginx/sites-enabled/
...
echo ""
echo "🌐 URLs de acesso:"
echo "   Frontend: http://novo.samcast.com.br"
echo "   Backend API: http://novo.samcast.com.br:3001/api"
echo "   Health Check: http://novo.samcast.com.br:3001/api/health"
echo ""
echo "📊 Comandos úteis:"
...
echo "1. Verificar se o domínio novo.samcast.com.br aponta para este servidor"
echo "2. Configurar firewall: sudo ufw allow 80 && sudo ufw allow 3001 && sudo ufw allow 1935"
echo "3. Testar acesso: curl http://novo.samcast.com.br"