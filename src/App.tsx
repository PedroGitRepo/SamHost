...
import GravadorTransmissao from './pages/dashboard/GravadorTransmissao';
import DiagnosticarProblemas from './pages/dashboard/DiagnosticarProblemas';
import AgendamentosRelay from './pages/dashboard/AgendamentosRelay';
import GerenciarLogos from './pages/dashboard/GerenciarLogos';
          ...
          <StreamProvider>
            <Routes>
              ...
              >
                ...
                <Route path="gravador-transmissao" element={<ErrorBoundary><GravadorTransmissao /></ErrorBoundary>} />
                <Route path="diagnosticar-problemas" element={<ErrorBoundary><DiagnosticarProblemas /></ErrorBoundary>} />
                <Route path="agendamentos-relay" element={<ErrorBoundary><AgendamentosRelay /></ErrorBoundary>} />
                <Route path="gerenciar-logos" element={<ErrorBoundary><GerenciarLogos /></ErrorBoundary>} />
              </Route>
