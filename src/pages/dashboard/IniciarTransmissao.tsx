          ...
          setLives(prev => {
            ...
            if (!hasActiveLive) {
              ...
              const virtualLive = {
                ...
                data_fim: '',
                tipo: 'obs',
                servidor_stm: `https://stmv20.samcast.com.br/${userLogin}/${userLogin}_live/playlist.m3u8`,
  ...
  try {
    ...
    if (data.success) {
      ...
      if (activeLive && sourceUrls) {
        ...
        setCurrentPlayerUrl(
          `${baseUrl}/api/player-port/iframe?login=${userLogin}&player=1&contador=true`
        );
        setShowPlayer(true);
      } else {
        setShowPlayer(false);
