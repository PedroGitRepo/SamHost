...
const Playlists: React.FC = () => {
  ...
  const openVideoInNewTab = (video: Video) => {
    ...
    if (pathParts.length >= 3) {
      ...
      const externalUrl = `http://${domain}:1443/play.php?login=${userLogin}&video=${folderName}/${finalFileName}`;
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6">
          ...
          <div className="mt-4 p-3 bg-green-100 rounded-md">
            <p className="text-green-800 text-sm">
              <strong>📺 URL de Transmissão:</strong> http://stmv20.samcast.com.br/{userLogin}/smil:playlists_agendamentos.smil/playlist.m3u8
            </p>
          </div>
        </div>
      )}
              ...
              {selectedLogoId && (
                <>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    ...
                    <img
                      src={`http://stmv20.samcast.com.br/content${logos.find(l => l.id === selectedLogoId)?.url}`}
                      alt="Preview"
