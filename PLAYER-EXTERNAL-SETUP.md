...
Sistema completo de player externo para `playerv.novo.samcast.com.br` que integra com o painel de streaming e detecta automaticamente transmissões ativas.
...
```apache
<VirtualHost *:80>
    ServerName playerv.novo.samcast.com.br
...
server {
    listen 80;
    server_name playerv.novo.samcast.com.br;
...
### URL Base
```
https://playerv.novo.samcast.com.br/?login=usuario&player=1
```
...
```
https://playerv.novo.samcast.com.br/?login=usuario&player=1&contador=true&compartilhamento=true
```

#### VOD Específico
```
https://playerv.novo.samcast.com.br/?login=usuario&vod=filmes/filme.mp4&player=1
```

#### Player Clappr com Autoplay
```
https://playerv.novo.samcast.com.br/?login=usuario&player=2&autoplay=true&muted=true
```
...
- URLs agora apontam para playerv.novo.samcast.com.br
...
scp -r player-external/* root@novo.samcast.com.br:/var/www/playerv/

# Configurar permissões
ssh root@novo.samcast.com.br "chown -R www-data:www-data /var/www/playerv/ && chmod -R 755 /var/www/playerv/"
```

### Configurar Apache/Nginx
```bash
# Apache
sudo a2ensite playerv.novo.samcast.com.br
sudo systemctl reload apache2

# Nginx  
sudo ln -s /etc/nginx/sites-available/playerv.novo.samcast.com.br /etc/nginx/sites-enabled/
...
curl -I https://playerv.novo.samcast.com.br/?login=teste&player=1

# Testar API
curl https://playerv.novo.samcast.com.br/api/stream-status.php?login=teste
```
...
curl -f https://playerv.novo.samcast.com.br/?login=teste
...
1. ✅ Configurar subdomínio playerv.novo.samcast.com.br
