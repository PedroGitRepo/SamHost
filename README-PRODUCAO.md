# Deploy para Produção - novo.samcast.com.br
...
- Domínio novo.samcast.com.br apontando para o servidor
...
```bash
# Verificar backend
curl http://novo.samcast.com.br:3001/api/health

# Verificar frontend
curl http://novo.samcast.com.br

# Verificar streaming
curl http://novo.samcast.com.br:1935/samhost/test_live/playlist.m3u8
```
...
sudo certbot --nginx -d novo.samcast.com.br
