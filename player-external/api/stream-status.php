...
try {
    ...
    if ($transmission) {
        ...
        $response['stream_url'] = "http://stmv20.samcast.com.br/{$userLogin}/smil:playlists_agendamentos.smil/playlist.m3u8";
        ...
        if ($apiResponse) {
            ...
            if ($obsData && $obsData['success'] && $obsData['obs_stream']['is_live']) {
                $obsStreamUrl = "http://stmv20.samcast.com.br/{$userLogin}/{$userLogin}_live/playlist.m3u8";
